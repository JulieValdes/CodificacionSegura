...
<body class="bg-gray-50 dark:bg-gray-900">
    <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-800">
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow-lg p-6 max-w-sm w-full">
            <h1 class="text-2xl font-bold text-center text-gray-900 dark:text-white mb-4">Verifica tu Inicio de Sesión</h1>
            ...
            <form action="{{ route('verification.resendTwoFactor') }}" method="POST" class="mb-4">
                @csrf
            ...
            <form action="{{ route('verification.twoFactor') }}" method="POST">
                @csrf
